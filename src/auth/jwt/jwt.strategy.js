...
var JwtStrategy = function () {
    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(prisma) {
            var _this = this;
            var jwtExtractor = passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken();
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (!user || user.tokenVersion !== payload.tokenVersion) {
                                throw new common_1.UnauthorizedException('Token inválido o caducado');
                            }
                        ...
                        case 2:
                            customer = _a.sent();
                            if (!customer) {
                                throw new common_1.InternalServerErrorException('The server could not create the customer, try again');
                            }
                            return [2 /*return*/, {
                                    sub: user.id,
