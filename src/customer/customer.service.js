...
var CustomerService = function () {
    ...
    var CustomerService = _classThis = /** @class */ (function () {
        function CustomerService_1(prisma, userService) {
            this.prisma = prisma;
            this.userService = userService;
        }
        CustomerService_1.prototype.create = function (newCustomerInfo) {
            return __awaiter(this, void 0, void 0, function () {
                var id, user, customer;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            customer = _a.sent();
                            return [2 /*return*/, { customer: customer, tokenVersion: user.tokenVersion }];
                    }
                });
            });
        };
